...
|번호| 손상 종류               |번호|	손상 종류              |           
|---|-----------------------|----|------------------------|
|203|덕트 손상 (덕트)         |209| 연결 불량 (덕트)        |
|212| 테이프 불량 (덕트)      |401| 볼트 체결 불량 (선박 배관)|
|402| 파이프 손상 (선박 배관)  |202| 단차 (선체)             |
|206| 보강재 설치 불량 (선체)  |205| 바인딩 불량 (케이블)     |
|208| 설치 불량 (케이블)      |211| 케이블 손상 (케이블)     | 
|201| 가공 불량 (보온재)      |207| 보온재 손상 (보온재)     |
|210| 연계 처리 불량 (보온재)  |213| 함석 처리 불량 (보온재)  |
